...
class WGLInitGenerator(OutputGenerator):
	...
	def beginFile(self, genOpts):
		...
		write('HMODULE AnyGL_gllib;', file = self.outFile)
	...
	def endFile(self):
		...
		write('\tif (AnyGL_gllib)\n\t{', file = self.outFile)
		write('\t\tFreeLibrary(AnyGL_gllib);', file = self.outFile)
		write('\t\tAnyGL_gllib = NULL;', file = self.outFile)
		write('\t}\n}', file = self.outFile)
